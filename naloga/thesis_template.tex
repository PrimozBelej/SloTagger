...
Pri glagolskih oblikah je iz matrike \ref{fig:confusionglagolskeoblike} razvidno, da označevalnik vsem oblika razen namenilniku in velelniku dodeljuje pravilne oznake. Glagolom v namenilniku v petini primerov dodeli vrednost, ki označuje, da beseda ni glagol. Velelnik prav tako v petini primerov narobe označi kot sedanjik.
...
Živost je redka lastnost in se pripisuje samo samostalnikom moškega spola ednine v tožilniku. Na sliki \ref{fig:confusionzivost} vidimo, da označevalnik dobro prepozna, kdaj živost ni primerna. Opazimo pa, da pri velikem delu primerov, pri katerih je ta lastnost, napove neveljavnost oznake živosti.
